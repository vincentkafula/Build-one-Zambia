    ...
    <svg width="22" height="22" viewBox="0 0 24 24">
      <defs>
        ...
        <linearGradient id="playGreen" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#66e37a" /><stop offset="100%" stopColor="#00c46a" />
        </linearGradient>
        <linearGradient id="playYellow" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#ffe95e" /><stop offset="100%" stopColor="#ffbf00" />
        </linearGradient>
        <linearGradient id="playRed" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#ff6a5c" /><stop offset="100%" stopColor="#e8203a" />
        </linearGradient>
      </defs>
      <path d="M3.6 2.3c-.4.3-.6.8-.6 1.4v16.6c0 .6.2 1.1.6 1.4l.1.1L13 12.4v-.2L3.7 2.2l-.1.1z" fill="url(#playBlue)" />
      <path d="M16.1 15.5 13 12.4v-.2l3.1-3.1.1.1 3.7 2.1c1.1.6 1.1 1.6 0 2.2l-3.7 2.1-.1-.1z" fill="url(#playYellow)" />
      <path d="M16.2 15.4 13 12.2 3.6 21.6c.35.37.93.42 1.58.05l11.02-6.27" fill="url(#playRed)" />
      <path d="M16.2 9 5.18 2.75c-.65-.37-1.23-.32-1.58.05L13 12.2l3.2-3.2z" fill="url(#playGreen)" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ background: 'linear-gradient(135deg, #f97316, #dc2626)', color: '#fff', fontFamily: 'Oswald, sans-serif', letterSpacing: '0.05em', boxShadow: '0 2px 6px rgba(220,38,38,0.5)' }}
      >
