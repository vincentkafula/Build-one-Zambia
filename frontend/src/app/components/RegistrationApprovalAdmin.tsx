...
function AgentDetail({ reg }: { reg: AgentReg }) {
  return (
    <div className="space-y-4">
      {reg.accountCreationFailed && (
        <div className="rounded-lg border border-amber-300 bg-amber-50 px-3 py-2 text-xs text-amber-800">
          <strong>Account creation failed at submission time:</strong> {reg.accountCreationError || 'Unknown error'}.
          This applicant has no login account yet — use "Grant Login" below to create one manually once approved.
        </div>
      )}
      <div>
