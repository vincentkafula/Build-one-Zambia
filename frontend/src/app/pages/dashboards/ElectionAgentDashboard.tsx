  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl p-7" style={{ backgroundColor: '#007A30', border: `1px solid ${roleInfo?.color ?? 'rgba(255,255,255,0.08)'}30` }}>
              ...
              <div className="relative">
                ...
                {dropdownOpen && (
                  <div className="absolute top-full left-0 right-0 mt-1 rounded-xl overflow-hidden z-50"
                    style={{ backgroundColor: '#007A30', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 8px 32px rgba(0,0,0,0.5)' }}>
