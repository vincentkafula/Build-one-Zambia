...
export function NationalECZEntryPage() {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    // approved provincial manager figures for this election type. Registered
    // voters and total votes cast are auto-derived, so they can only
    // mismatch through the candidate/rejected-ballot figures.
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 pt-5" style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
            ...
            <div>
              ...
              <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: '0.68rem', marginTop: 4 }}>
                Candidate votes + rejected ballots · Provinces: {approvedTotals.total.toLocaleString()}
              </p>
            </div>
            <div>
