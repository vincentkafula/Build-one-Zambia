  ...
  return (
    <div className="p-3 pb-0">
      <div className="relative overflow-hidden rounded-lg" style={{ aspectRatio: '4 / 5', backgroundColor: '#F7F5EF' }}>
        {!imgError ? (
          <img src={shadowCabinetApi.photoUrl(id, 'male')} alt={name}
        ...
        <section className="py-20 px-4" style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="max-w-6xl mx-auto" style={{ position: 'relative', zIndex: 1 }}>
            <div className="text-center mb-14">
              ...
              <h2 style={{ fontFamily: 'Oswald, sans-serif', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', letterSpacing: '0.03em', color: '#ffffff' }}>ADDITIONAL MALE SHADOW MINISTERS</h2>
              <div className="w-16 h-1 mx-auto mt-4 rounded-full" style={{ backgroundColor: O }} />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
              {shadowMembers.map(m => (
