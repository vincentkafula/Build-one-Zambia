...
const PRODUCTS = [
  ...
  { id: 2,  name: 'BOZ Hoodie',                   price: 'K280',  priceNum: 280,  tag: 'APPAREL',     desc: 'Premium hoodie embroidered with the Build One Zambia logo and 2031 campaign slogan.',            img: '/products/hoodie-green.jpg',
    colors: [
      { name: 'Green',  swatch: '#00712B', img: '/products/hoodie-green.jpg' },
      { name: 'Orange', swatch: '#EA580C', img: '/products/hoodie-orange.jpg' },
      { name: 'Black',  swatch: '#111111', img: '/products/hoodie-black.jpg' },
      { name: 'Navy',   swatch: '#1e3a5f', img: '/products/hoodie-navy.jpg' },
      { name: 'White',  swatch: '#FFFFFF', img: '/products/hoodie-white.jpg' },
      { name: 'Gray',   swatch: '#4b5563', img: '/products/hoodie-gray.jpg' },
    ],
  },
  ...
  { id: 24, name: 'BOZ Novelty Socks',            price: 'K45',   priceNum: 45,   tag: 'APPAREL',     desc: 'Fun novelty socks featuring party colours and logo patterns.',                                    img: '/products/socks-green.jpg',
    colors: [
      { name: 'Green',  swatch: '#00712B', img: '/products/socks-green.jpg' },
      { name: 'Orange', swatch: '#EA580C', img: '/products/socks-orange.jpg' },
      { name: 'Black',  swatch: '#111111', img: '/products/socks-black.jpg' },
      { name: 'White',  swatch: '#FFFFFF', img: '/products/socks-white.jpg' },
      { name: 'Navy',   swatch: '#1e3a5f', img: '/products/socks-navy.jpg' },
      { name: 'Gray',   swatch: '#6b7280', img: '/products/socks-gray.jpg' },
    ],
  },
  ...
  { id: 27, name: 'BOZ Polo Shirt',               price: 'K195',  priceNum: 195,  tag: 'APPAREL',     desc: 'Premium cotton polo shirt embroidered with the Build One Zambia logo on the chest. Available in 6 colours. Sizes S–3XL.', img: '/products/polo-green.jpg',
    colors: [
      { name: 'Green',  swatch: '#00712B', img: '/products/polo-green.jpg' },
      { name: 'Orange', swatch: '#EA580C', img: '/products/polo-orange.jpg' },
      { name: 'Black',  swatch: '#111111', img: '/products/polo-black.jpg' },
      { name: 'White',  swatch: '#FFFFFF', img: '/products/polo-white.jpg' },
      { name: 'Navy',   swatch: '#1e3a5f', img: '/products/polo-navy.jpg' },
      { name: 'Gray',   swatch: '#4b5563', img: '/products/polo-gray.jpg' },
    ],
  },
  ...
  { id: 30, name: 'BOZ Chitenge Wrap',            price: 'K85',   priceNum: 85,   tag: 'APPAREL',     desc: 'Traditional chitenge fabric printed with the Build One Zambia pattern and colours.',              img: '/products/chitenge-green.jpg',
    colors: [
      { name: 'Green',        swatch: '#00712B', img: '/products/chitenge-green.jpg' },
      { name: 'Orange',       swatch: '#EA580C', img: '/products/chitenge-orange.jpg' },
      { name: 'Black',        swatch: '#111111', img: '/products/chitenge-black.jpg' },
      { name: 'White',        swatch: '#FFFFFF', img: '/products/chitenge-white.jpg' },
      { name: 'Forest Green', swatch: '#0d3d1f', img: '/products/chitenge-forest.jpg' },
      { name: 'Maroon',       swatch: '#6b1530', img: '/products/chitenge-maroon.jpg' },
    ],
  },
  ...
  { id: 44, name: 'BOZ Windbreaker',              price: 'K380',  priceNum: 380,  tag: 'APPAREL',     desc: 'Lightweight windbreaker in party colours, ideal for outdoor canvassing.',                       img: '/products/windbreaker-green.jpg',
    colors: [
      ...
      { name: 'Orange', swatch: '#EA580C', img: '/products/windbreaker-orange.jpg' },
      { name: 'Black',  swatch: '#111111', img: '/products/windbreaker-black.jpg' },
      { name: 'Navy',   swatch: '#1e3a5f', img: '/products/windbreaker-navy.jpg' },
      { name: 'White',  swatch: '#FFFFFF', img: '/products/windbreaker-white.jpg' },
      { name: 'Gray',   swatch: '#4b5563', img: '/products/windbreaker-gray.jpg' },
    ],
  },
